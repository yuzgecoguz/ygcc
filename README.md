...
[![npm version](https://img.shields.io/badge/npm-v1.7.0-blue)](https://www.npmjs.com/package/@ygcc/ygcc)
...
- **Multi-Auth Support** — HMAC-SHA256/384/512 (hex, Base64), SHA512 (Kraken/Gate.io), JWT/ES256 (Coinbase)
...
| Method | Description | Binance | Bybit | OKX | Kraken | Gate.io | KuCoin | Coinbase | Bitfinex |
|--------|-------------|---------|-------|-----|--------|---------|--------|----------|----------|
...
```
ygcc/
├── index.js                    # Entry point: const { Binance, Bybit, Okx, Kraken, Gateio, KuCoin, Coinbase, Bitfinex } = require('@ygcc/ygcc')
├── lib/
...
└── tests/
    ...
    └── bitfinex.test.js        # 90 tests — Bitfinex V2 implementation
```
